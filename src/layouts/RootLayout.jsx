    ...
    return (
        <div className=' sm:flex sm:flex-col h-screen bg-gradient-to-b from-[hsl(214,47%,23%)] to-[hsl(237,49%,15%)]'>
            <div className=' container mx-auto flex flex-col h-screen justify-between'>
                <header className='flex justify-between items-center outline outline-4 outline-[hsl(217,16%,45%)] rounded-lg mt-5 mb-5 p-2'>
                ...
                <footer className=' flex justify-center text-white pb-10 font-Barlow'>
                    ...
                    {isClicked && 
                        (<div className='flex flex-col items-center justify-between h-screen w-full absolute top-0 bg-white pb-24 z-30'>
